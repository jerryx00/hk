<?php
    ...
    * CZ接口
    */
    class SporderController extends BaseorderController {

        protected $ORDER_POST_URL = '/Spauth/order?';
        protected $ORDER_NOTIFY_URL = '/Spauth/notify';

        protected $ORDER_MODEL = 'order_sp';
        protected $GOODS_MODEL = 'goods_sp';
        protected $MODE_TEST = true;
        ...
        public function insert() { 
            ...
            //$d['backurl'] = 'http://139.224.59.94/llfx/api.php'.$this->ORDER_NOTIFY_URL;
            //$d['backurl'] = 'http://localhost/llfxdev/api.php'.$this->ORDER_NOTIFY_URL;
